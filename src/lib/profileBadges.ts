...
export const PROFILE_BADGES: ProfileBadge[] = [
  { id: "staff", name: "Staff", description: "Be a part of the Spider Website staff team.", icon: "wrench", color: "#6d8cff", glowColor: "#6d8cff" },
  { id: "helper", name: "Helper", description: "Be active and help users in the community.", icon: "lightbulb", color: "#e8a33d", glowColor: "#e8a33d" },
  { id: "premium", name: "Premium", description: "Purchase the premium package.", icon: "gem", color: "#a855f7", glowColor: "#a855f7" },
  { id: "verified", name: "Verified", description: "Purchase or be a known content creator.", icon: "badge-check", color: "#0ea5e9", glowColor: "#0ea5e9" },
  { id: "donor", name: "Donor", description: "Support the Spider Website community.", icon: "badge-dollar", color: "#18c77a", glowColor: "#18c77a" },
  { id: "gifter", name: "Gifter", description: "Gift a Spider Website product to another user.", icon: "gift", color: "#fbbf24", glowColor: "#fbbf24" },
  { id: "image-host", name: "Image Host", description: "Purchase the Image Host package.", icon: "star", color: "#22d3a0", glowColor: "#22d3a0" },
  { id: "domain-legend", name: "Domain Legend", description: "Add a public custom domain.", icon: "rocket", color: "#ff6b61", glowColor: "#ff6b61" },
  { id: "og", name: "OG", description: "Be an early supporter of Spider Website.", icon: "medal", color: "#f2cf24", glowColor: "#f2cf24" },
  { id: "server-booster", name: "Server Booster", description: "Boost the community server.", icon: "flame", color: "#f97316", glowColor: "#f97316" },
  { id: "hone", name: "Hone.gg", description: "Earned by redeeming a partner reward.", icon: "gauge", color: "#f59e0b", glowColor: "#f59e0b" },
  { id: "bug-hunter", name: "Bug Hunter", description: "Report a bug to the Spider Website team.", icon: "bug", color: "#42d47b", glowColor: "#42d47b" },
  { id: "summer-2026", name: "Summer 2026", description: "Exclusive badge from the 2026 summer event.", icon: "sun", color: "#f7c948", glowColor: "#f7c948" },
  ...
  { id: "third-place", name: "Third Place", description: "Get third place in a Spider Website event.", icon: "award", color: "#c77b35", glowColor: "#c77b35" },
];
