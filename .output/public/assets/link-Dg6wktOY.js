import { a as e, i as t, o as n, r, t as i } from "./useRouter-Dpb7RwMI.js";
function a(e) {
  return e[e.length - 1];
}
function o(e, t) {
...
function _(e, t, n) {
  ...
  if (Array.isArray(e) && Array.isArray(t)) {
    ...
    for (let r = 0, i = e.length; r < i; r++) if (!_(e[r], t[r], n)) return !1;
    return !0;
  }
  if (m(e) && m(t)) {
    ...
    if (n?.partial) {
      for (let i in t)
        if ((!r || t[i] !== void 0) && !_(e[i], t[i], n)) return !1;
      return !0;
    }
    let i = 0;
    ...
    let a = 0;
    for (let o in t)
      if ((!r || t[o] !== void 0) && (a++, a > i || !_(e[o], t[o], n)))
        return !1;
    return i === a;
  }
  return !1;
...
var A = 4,
  ne = 5;
function re(e, t, n = new Uint16Array(6)) {
  let r = e.indexOf(`/`, t),
    i = r === -1 ? e.length : r,
    a = e.substring(t, i);
  if (!a || !a.includes(`$`))
...
function j(e, t, n, r, i, a, o, s) {
  ...
  if (n.children) for (let r of n.children) j(e, t, r, c, i, a, o, s);
}
function ie(e, t) {
...
function oe(e, t) {
  let n = M(`/`),
    r = new Uint16Array(6),
    i = [];
  for (let t of e) j(!1, r, t, 1, n, 0, i);
  for (let e of i) e.sort(ie);
  ((t.masksTree = n), (t.flatCache = k(1e3)));
}
function N(e, t) {
  e ||= `/`;
  let n = t.flatCache.get(e);
  if (n !== void 0) return n;
  let r = I(e, t.masksTree);
...
function se(e, t, n, r, i) {
  ...
  return (
    o ||
      ((o = M(`/`)),
      j(t, new Uint16Array(6), { from: e }, 1, o, 0),
...
function ce(e, t, n = !1) {
  ...
  let a;
  try {
    a = I(e, t.segmentTree, n);
  } catch (e) {
    if (e instanceof URIError) a = null;
    else throw e;
  }
  return (a && (a.branch = R(a.route)), t.matchCache.set(r, a), a);
}
function P(e) {
...
function F(e, t = !1, n) {
  let r = M(e.fullPath),
    ...
    c = 0;
  j(t, i, e, 1, r, 0, a, (e) => {
    if ((n?.(e, c), e.id in o && te(), (o[e.id] = e), c !== 0 && e.path)) {
      let t = P(e.fullPath);
      (!s[t] || e.fullPath.endsWith(`/`)) && (s[t] = e);
    }
    c++;
  });
  for (let e of a) e.sort(ie);
  return {
    processedTree: {
      segmentTree: r,
      singleCache: k(1e3),
...
function B(e, t, n, r) {
  ...
  for (; c.length;) {
    ...
    if (i.kind === 2 && i.route && !W(u, n)) continue;
    if (i.parse) {
      if (!U(e, t, n)) continue;
      ((g = n.rawParams), (h = n.extract));
    }
    r && i.route && i.kind !== A && W(l, n) && (l = n);
    let _ = a === s;
    if (
      _ &&
      (i.route && (!o || i.kind === A || i.kind === 2) && W(u, n) && (u = n),
    ...
    if (_ && i.index) {
      let n = {
        ...
        r = !0;
      if ((i.index.parse && (U(e, t, n) || (r = !1)), r)) {
        if (!p && !m && !d && H(f, s)) return n;
        W(u, n) && (u = n);
      }
    }
    if (i.wildcard)
      for (let e = i.wildcard.length - 1; e >= 0; e--) {
        ...
        if (
          !r ||
          (!_ && (n.caseSensitive ? v : (y ??= v.toLowerCase())).startsWith(r))
        ) {
          if (o) {
            if (_) continue;
            let e = t.slice(a).join(`/`),
              i = e.slice(-o.length);
            if (
              (n.caseSensitive ? i : i.toLowerCase()) !== o ||
              e.length - o.length < r.length
            )
              continue;
          }
          c.push({
      ...
      if (!_)
        for (let e = i.optional.length - 1; e >= 0; e--) {
          ...
          if (n || r) {
            ...
            if (
              (n && !e.startsWith(n)) ||
              (r && e.indexOf(r, e.length - r.length) < n.length)
            )
              continue;
          }
          c.push({
  ...
  if (r && l) {
    ...
    return (
      (l.rawParams ??= Object.create(null)),
      (l.rawParams[`**`] = decodeURIComponent(r)),
      l
    );
  }
  return null;
...
function ue({ base: e, to: t, trailingSlash: n = `never`, cache: r }) {
  if ((t.includes(`//`) && (t = K(t)), t.startsWith(`/`)))
  ...
  s.length > 1 &&
    (a(s) === `` ? n === `never` && s.pop() : n === `always` && s.push(``));
  let c = s.join(`/`),
    l = (i ? K(c) : c) || `/`;
...
var he = `Error preloading route! ☝️`,
  Z = n(t(), 1),
  ge = Z.use,
  _e = Z.useLayoutEffect;
function ve(e, t, n) {
  Z.useEffect(() => {
    if (!e.current || n || typeof IntersectionObserver != `function`)
      return () => t();
...
var be = r();
function xe({ children: e, fallback: t = null }) {
  return (0, be.jsx)(Z.Fragment, { children: Se() ? e : t });
}
function Se() {
...
function ke(e, t, n = Oe) {
  ...
  return (0, De.useSyncExternalStoreWithSelector)(r, i, i, t, n);
}
function Ae(e) {
  let t = Z.useRef(e);
  return (
    _(t.current, e, { ignoreUndefined: !1 }) || (t.current = e),
    t.current
  );
}
function je(e, t) {
...
function Me(e, t, n) {
  if (e?.external) return C(e.href, n) ? void 0 : e.href;
  if (!Ve(t) && typeof t == `string` && t.indexOf(`:`) !== -1)
    try {
      return (new URL(t), C(t, n) ? void 0 : t);
    } catch {}
}
function Ne(e, t, n, r, i, a) {
  if (a) return !1;
  if (n?.exact) {
    if (!X(e.pathname, t.pathname, r)) return !1;
  } else {
    let n = Y(e.pathname, r),
      i = Y(t.pathname, r);
...
function Pe(e, t) {
  let n = i(),
    ...
    I = Z.useCallback(
      (e) => {
        let t = n.buildLocation({ _fromLocation: e, ...F }),
          r = Be(
          ...
          i = Me(r, l, n.protocolAllowlist);
        return [r?.href, i, Ne(e, t, P, n.basepath, N, i !== void 0)];
      },
      [P, b, N, F, n, l],
    ),
    [L, R, z] = ke(n.stores.location, I, je),
    B = z ? (o(a, {}) ?? Ie) : Fe,
    V = z ? Fe : (o(s, {}) ?? Fe),
    H = [S, B.className, V.className].filter(Boolean).join(` `),
    U = (x || B.style || V.style) && { ...x, ...B.style, ...V.style },
    W = Z.useRef(!1),
    G = e.reloadDocument || R || b ? !1 : (u ?? n.options.defaultPreload),
    K = d ?? n.options.defaultPreloadDelay ?? 0,
    q = Z.useCallback(() => {
      n.preloadRoute(F).catch((e) => {
        (console.warn(e), console.warn(he));
      });
    }, [n, F]),
    J = Z.useCallback(
      (e) => {
        ...
        if (!(e.isIntersecting ?? G === `intent`)) {
          e.isIntersecting === !1 && ze(r);
          return;
        }
        if (!K) {
          q();
  ...
  (ve(r, J, G !== `viewport`),
    Z.useEffect(() => {
      W.current || (G === `render` && (q(), (W.current = !0)));
    }, [q, G]));
  let le = (e) => {
...
var Fe = {},
  Ie = { className: `active` },
  Le = { role: `link`, "aria-disabled": !0 },
  Re = { "data-status": `active`, "aria-current": `page` },
  Q = new WeakMap(),
  ze = (e) => {
    (clearTimeout(Q.get(e)), Q.delete(e));
  },
  $ = (e) => (t) => {
    for (let n of e)
      if (n) {
