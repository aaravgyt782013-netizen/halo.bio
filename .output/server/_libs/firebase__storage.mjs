import { M as pingServer, S as getModularInstance, T as isCloudWorkstation, a as getApp, b as getDefaultEmulatorHostnameAndPort, h as createMockUserToken, i as _registerComponent, n as _getProvider, p as FirebaseError, r as _isFirebaseServerApp, s as registerVersion, t as SDK_VERSION, u as Component } from "./@firebase/app+[...].mjs";
...
function utf8Bytes_(value) {
	...
	for (let i = 0; i < value.length; i++) {
		...
		if (c <= 127) b.push(c);
			...
			if (!(i < value.length - 1 && (value.charCodeAt(i + 1) & 64512) === 56320)) b.push(239, 191, 189);
			else {
				const hi = c;
...
var UploadTask = class {
	...
	*/
	...
	_start() {
		...
		if (this._resumable) {
			if (this._uploadUrl === void 0) this._createResumable();
	...
	_increaseMultiplier() {
		if (RESUMABLE_UPLOAD_CHUNK_SIZE * this._chunkMultiplier * 2 < 33554432) this._chunkMultiplier *= 2;
	}
	_fetchMetadata() {
		this._resolveToken((authToken, appCheckToken) => {
...
registerStorage();
//#endregion
export { StringFormat as a, connectStorageEmulator as c, getStorage as d, invalidArgument as f, uploadBytesResumable as h, StorageErrorCode as i, dataFromString as l, ref as m, Location as n, TaskState as o, invalidRootOperation as p, StorageError as r, UploadTask as s, FbsBlob as t, getDownloadURL as u };
