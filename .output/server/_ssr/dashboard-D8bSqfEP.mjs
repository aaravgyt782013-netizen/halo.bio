...
import { i as ensureProtocol, n as auth, r as db, s as uploadMedia } from "./bio-ChKk3DWZ.mjs";
...
import { t as ProfileView } from "./ProfileView-BqggIaIO.mjs";
import { n as useIsAdmin, r as useMyProfile, t as useAuth } from "./useAuth-BFsATsOe.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/dashboard-D8bSqfEP.js
	...
	return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("main", {
				className: "mx-auto grid max-w-6xl w-full overflow-hidden gap-6 px-4 py-6 lg:grid-cols-[1fr_360px]",
				children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("section", {
					className: `glass-panel p-4 sm:p-7 shadow-lift w-full max-w-full overflow-hidden ${mobileView === "preview" ? "hidden lg:block" : "block"}`,
					children: [
						/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
