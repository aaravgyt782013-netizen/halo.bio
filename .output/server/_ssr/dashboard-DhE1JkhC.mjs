...
import { c as uploadMedia, i as ensureProtocol, n as auth, r as db, s as optimizeImageDataUrl } from "./bio-NPPVUTaD.mjs";
import { r as require_react } from "../_libs/react+tanstack__react-query.mjs";
import { v as Link, y as useNavigate } from "../_libs/@tanstack/react-router+[...].mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { t as require_jsx_dev_runtime } from "../_libs/react.mjs";
import { $ as ExternalLink, A as PenLine, B as LoaderCircle, D as Plus, F as MousePointerClick, H as Link2, M as Palette, O as Play, P as Music4, Q as EyeOff, R as LogOut, T as RotateCcw, U as Layers, Z as Eye, _ as SlidersVertical, a as Volume2, g as Smartphone, h as Sparkles, i as VolumeX, it as ChartColumn, j as Pause, k as Pen, l as Upload, m as Square, nt as CircleAlert, o as Video, p as Trash2, q as GripVertical, r as X, rt as Check, st as ArrowUp, t as Zap, tt as Copy, ut as ArrowDown, v as Shield, w as Save, x as Share2, y as ShieldCheck } from "../_libs/lucide-react.mjs";
import { i as getPlatformConfig, n as SUPPORTED_PLATFORMS, r as formatSocialUrl, t as ProfileView } from "./ProfileView-8EtPyXBV.mjs";
import { n as useIsAdmin, r as useMyProfile, t as useAuth } from "./useAuth-CCjzNA5i.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/dashboard-DhE1JkhC.js
...
function SocialLinksEditor({ socialLinks = [], onChange, accentColor = "#3b82f6", userId = "default" }) {
	...
	const [customRemoveBg, setCustomRemoveBg] = (0, import_react.useState)(true);
	const [customFitMode, setCustomFitMode] = (0, import_react.useState)("cover");
	...
	const [editRemoveBgValue, setEditRemoveBgValue] = (0, import_react.useState)(true);
	const [editFitModeValue, setEditFitModeValue] = (0, import_react.useState)("cover");
	...
	const handleQuickAdd = (platform) => {
		...
		if (existing) {
			...
			setEditRemoveBgValue(existing.remove_bg !== void 0 ? existing.remove_bg : existing.platform === "custom");
	...
	const handleStartEdit = (link) => {
		...
		setEditRemoveBgValue(link.remove_bg !== void 0 ? link.remove_bg : link.platform === "custom");
				...
				children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
						...
						children: [
							...
							customIconUrl && /* @__PURE__ */ (void 0)("div", {
								...
								children: [/* @__PURE__ */ (void 0)("label", {
									...
									children: [/* @__PURE__ */ (void 0)("input", {
										...
										className: "text-[11px] font-medium text-foreground group-hover:text-primary transition-colors",
										children: "Transparent Button (No BG)"
									}, void 0, false, {
										fileName: _jsxFileName$1,
										lineNumber: 488,
										columnNumber: 21
									...
									children: [/* @__PURE__ */ (void 0)("input", {
										...
										onChange: (e) => setCustomFitMode(e.target.checked ? "cover" : "contain"),
										className: "rounded border-border bg-background text-primary focus:ring-primary h-3.5 w-3.5"
									}, void 0, false, {
										fileName: _jsxFileName$1,
										lineNumber: 493,
										...
										className: "text-[11px] font-medium text-foreground group-hover:text-primary transition-colors",
										children: "Fill Full Button (Cover)"
									}, void 0, false, {
										fileName: _jsxFileName$1,
										lineNumber: 501,
										columnNumber: 21
					...
					children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Plus, { className: "h-3.5 w-3.5" }, void 0, false, {
							...
							lineNumber: 523,
							columnNumber: 15
						}, this), /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { children: isUploadingIcon ? "Uploading..." : "Add Custom Icon" }, void 0, false, {
							fileName: _jsxFileName$1,
							lineNumber: 524,
							columnNumber: 15
						}, this)]
						...
						return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
									...
									style: {
										backgroundColor: isCustom ? "rgba(139, 92, 246, 0.15)" : config.color,
										border: isCustom ? "1px solid rgba(139, 92, 246, 0.3)" : void 0
									},
											...
											/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("label", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("input", {
														...
														onChange: (e) => setEditRemoveBgValue(e.target.checked),
														...
														className: "text-[10px] font-medium text-foreground group-hover:text-primary transition-colors",
													...
													lineNumber: 688,
													columnNumber: 29
												}, this), isCustom && /* @__PURE__ */ (void 0)("label", {
													className: "flex items-center gap-1.5 cursor-pointer group",
													children: [/* @__PURE__ */ (void 0)("input", {
														type: "checkbox",
														checked: editFitModeValue === "cover",
														onChange: (e) => setEditFitModeValue(e.target.checked ? "cover" : "contain"),
														className: "rounded border-border bg-background text-primary focus:ring-primary h-3 w-3"
													}, void 0, false, {
														fileName: _jsxFileName$1,
														lineNumber: 703,
	...
	const saveProfile = async () => {
		...
		try {
			...
			if (profile.background_type === "video") {
				...
				else if (finalBgValue.startsWith("data:video/")) try {
					toast.info("Transferring video to media streaming server...");
					const blob = await (await fetch(finalBgValue)).blob();
					const file = new File([blob], `bg-video-${Date.now()}.${blob.type.includes("webm") ? "webm" : "mp4"}`, { type: blob.type || "video/mp4" });
					finalBgValue = await uploadMedia(user.id, file, "backgrounds");
				} catch (vidErr) {
					console.error("Auto-migrating video to media server failed:", vidErr);
					if (finalBgValue.length > 819200) {
						toast.error("Legacy video file exceeds database size limits. It has been reset. Please upload your video again using the new Upload button.", { duration: 6e3 });
